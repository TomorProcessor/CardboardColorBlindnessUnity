Shader "Daltonize/Tritanope"
{
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			tritanope2[1] = 1.0;
			tritanope2[2] = 0.0;
			tritanope3[0] = -0.395913;
			tritanope3[1] = 0.801109;
			tritanope3[2] = 0.0;
			...
			l = tritanope1[0] * L + tritanope1[1] * M + tritanope1[2] * S;
			m = tritanope2[0] * L + tritanope2[1] * M + tritanope2[2] * S;
			s = tritanope3[0] * L + tritanope3[1] * M + tritanope3[2] * S;
